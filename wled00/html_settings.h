...
Do not enable if WiFi is working correctly, increases power consumption.</i><h3>
Ethernet Type</h3><select name="ETH"><option value="0">None</option><option 
value="1">WT32-ETH01</option><option value="2">ESP32-POE</option></select><br>
<hr><button type="button" onclick="B()">Back</button><button type="submit">
