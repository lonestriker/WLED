...
Ethernet Type</h3><select name="ETH"><option value="-1">None</option><option 
value="0">WT32-ETH01</option><option value="1">ESP32-POE</option><hr><button 
type="button" onclick="B()">Back</button><button type="submit">Save & Connect
</button></select></form></body></html>)=====";
